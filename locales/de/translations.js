export const TRANSLATION_DE = {
    ...
    accountChangeNameFormErrorUpdate: 'Fehler beim Aktualisieren von Name und Nachname',
    ...
    accountChangePasswordFormErrorUpdate: 'Fehler beim Aktualisieren des Passworts',
    accountChangePasswordFormOkUpdate: 'Passwort wurde aktualisiert, bitte melden Sie sich erneut an.',
    ...
    /* Auth - LoginForm */
    authLoginFormErrorLogin: 'Fehler beim Anmeldeversuch. Bitte überprüfen Sie Benutzer und Passwort',
    ...
    authRegisterFormErrorRegister: 'Fehler beim Versuch, den Benutzer zu registrieren',
    ...
    cartAddressShippingDeliveryExternal: 'Versand (außerhalb von BSAS und Cap. Fed.)',
    cartAddressShippingAddressNotSelected: 'Sie müssen eine Adresse aus der Liste auswählen.',
    ...
    cartPaymentFormPaymentErrorDelivery: 'Fehler bei der Bearbeitung der Bestellung.',
    ...
    summaryDetailAskForRemovalConfirmation: 'Möchten Sie es aus dem Warenkorb entfernen?',
    ...
    cartSuccessfulPaymentMsgSecondLine: 'Bei Fragen wenden Sie sich bitte an uns.',
    ...
    /* Cart - FailurePayment */
    cartFailurePaymentTitle: 'Die Bestellung konnte nicht korrekt bearbeitet werden.',
    cartFailurePaymentMsgFirstLine: 'Sie müssen zum Warenkorb zurückkehren und die Zahlung Ihrer Produkte erneut versuchen.',
    ...
    ordersOrderPurchaseOnItsWay: 'Die Bestellung wurde an folgende Adresse gesendet:',
    ...
    questionsErrorSendQuestionNotLogged: 'Sie müssen angemeldet sein, um Produktfragen zu stellen.',
    ...
    cartErrorTryingToDeleteItem: 'Beim Versuch, das Element zu entfernen, ist ein Fehler aufgetreten.',
